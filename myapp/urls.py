...
from .views import RegisterView, LoginView, DeviceListView, DeviceDetailView,ReportDataView, DashboardStatsView, toggle_device_status,PasswordResetRequestView,PasswordResetConfirmView
urlpatterns = [
